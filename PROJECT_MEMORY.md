...
1א. **המערכת לא מחוללת תוכן לימודי. לעולם.** יניב מביא את הדפים (PDF/תמונה/טקסט) והמערכת מייצרת אותם **בתמלול נאמן** לפי כללי העיצוב הקבועים. אסור להמציא תרגילים, מספרים, או גרפים; אסור להציע "מחוללי משימות/תרגילים". אם מקור לא קריא — מסמנים BLOCKED ושואלים את יניב, לא מנחשים.
