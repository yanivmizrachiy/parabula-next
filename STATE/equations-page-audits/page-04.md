...
- Topic-local page: 4 / 54
- Root page file: `עמוד-44.html`
- CSS file: `styles/pages/עמוד-44.css`
- SVG/content file: `pages/משוואות/assets/page-04.svg`
...
- Root worksheet page exists as `עמוד-44.html`.
- Page contains `main.a4-page.page-44`.
...
- Page-specific CSS is in `styles/pages/עמוד-44.css`.
...
- `.preview-nav` exists.
- `.nav-meta` says `משוואות — עמוד 4 / 54`.
- `.page-number` equals `4`.
- Active topic link is `משוואות` with `.is-active` and `aria-current="page"`.
- Previous/next links are topic-local: previous `עמוד-43.html`, next `עמוד-45.html`.

### F. Page CSS design rules

Status: partially OK.

- CSS is scoped to `.page-44`.
...
- The page content is loaded as an external SVG image: `pages/משוואות/assets/page-04.svg`.
...
Page 4 is **checked**, but **not finally approved as fully redesigned under `PROJECT_RULES.md`**.
