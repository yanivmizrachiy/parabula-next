  ...
  blocks: [
    ...
    task('השלימו כלל:',
      ...
      choices(['שווי שטח', 'חופפים תמיד', 'שווי היקף תמיד'])
        ...
        ,
        task('קבעו נקודה D על הישר y‪=‬7 כך ששטח ABD שווה לשטח ABC:',
                   note('השתמשו באותו בסיס AB. מה צריך להיות הגובה?', []),
                   expr(['גובה', '=', '_'], { label: 'הגובה:' }),
                   lines(2, { label: 'קודקוד D:' })
                 )
  ]
};
  ...
  blocks: [
    ...
    task('מי צודק?',
      ...
      lines(3, { label: 'כתבו מה נכון בכל הצעה ומה דורש תיקון:' })
        ...
        ,
        task('חישוב שטח בשיטת הפרישה על משולש PQR:',
                   note('P=(0,0), Q=(10,0), R=(4,8)', []),
                   expr(['שטח מלבן', '=', '_'], { label: 'שטח המלבן:' }),
                   expr(['שטח PQR', '=', '_'], { label: 'שטח PQR:' }),
                   lines(2, { label: 'הסבירו מדוע שטח PQR = שטח מלבן / 2:' })
                 )
        ,
        task('משולש עם שטח נתון — מצאו קודקוד אחר:',
                   note('בסיס AB=10, A=(0,0), B=(10,0), שטח נתון = 20', []),
                   lines(2, { label: 'מה צריך להיות הגובה?' }),
                   lines(2, { label: 'שני קודקודים אפשריים ל-C:' })
                 )
  ]
};
  ...
  blocks: [
    ...
    task('כתבו נקודה נוספת בכל קטגוריה:',
      ...
      exprPoint('נקודה מחוץ למשולש אך בתוך המלבן החוסם:')
        ...
        ,
        task('סיכום שיטת בדיקת השייכות:',
                   note('שימושו בשיטת בדיקת שטחות — השיטה עובדת רק אם סכום השטחות שווה לשטח ABC', []),
                   lines(2, { label: 'מייצגו נקודה שבתוך:' }),
                           lines(2, { label: 'מייצגו נקודה שמחוץ:' }),
                           lines(2, { label: 'מייצגו נקודה על צלע:' })
                     )
  ]
};
  ...
  blocks: [
    ...
    task('הוסיפו תנאי וקבעו אם התשובה יחידה:',
      table(['התנאי', 'מספר פתרונות', 'דוגמה'], [
        ...
        ,
        task('קודקוד C על ציר X — שטח נתון:',
                   note('בסיס AB=8, A=(1,0), B=(9,0), שטח=24. מצאו C על ציר X', []),
                   lines(2, { label: 'הגובה הדרושה:' }),
                   lines(2, { label: 'קודקוד C על ציר X:' }),
                   lines(2, { label: 'האם הפתרון יחיד? מדוע?' })
                 )
  ]
};
  ...
  blocks: [
    ...
    task('בנו נקודה S נוספת כך ששטח ABS יהיה זהה:',
      ...
      lines(2, { label: 'בדיקה:' })
        ...
        ,
        task('קבעו נקודה T על ישר y‪=‬8 כך ששטח ABT = 24:',
                   note('בסיס AB=8 והישר y‪=‬8 מקביל ל-AB', []),
                   lines(2, { label: 'הגובה הדרושה לשטח ABT=24:' }),
                   lines(3, { label: 'קודקוד T:' }),
                   lines(2, { label: 'האם T יחיד? הסבירו:' })
                 )
  ]
};
  ...
  blocks: [
    ...
    task('איתור טעות — תלמיד כתב: „כל תיכון מאונך לצלע ולכן השטחים שווים”.',
      lines(3, { label: 'תקנו את ההסבר:' })
        ...
        ,
        task('היפוך — שטח יחוסי בין תיכונים:',
                   note('אם שטח ABM = שטח ABN, האם MN נמצא מעל אב או מתחת?', []),
                   choices(['מעל ל-AB', 'מתחת ל-AB', 'יכול להיות בשני הכיוונים']),
                   lines(2, { label: 'הסבירו את תשובתכם:' })
                 )
  ]
};
