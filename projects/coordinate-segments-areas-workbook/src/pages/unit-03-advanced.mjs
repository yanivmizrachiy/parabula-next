// יחידה 3 — שטחי משולשים מתקדמים (עמודים 39–45).
...
function page39Grid() {
  ...
  [['A', 1, 1], ['B', 9, 1], ['C', 9, 7], ['D', 1, 7]].forEach(([label, x, y], i) =>
    g.point(x, y, label, { dx: i === 0 || i === 3 ? -5 : 5, dy: i < 2 ? 10 : -6 }));
  g.point(3, 7, 'P', { dx: 0, dy: -7 });
  g.point(6, 7, 'Q', { dx: 0, dy: -7 });
  return g;
}
...
function page40Grid() {
  ...
  g.point(0, 0, 'A', { dx: -5, dy: 11 });
  g.point(10, 0, 'B', { dx: 5, dy: 11 });
  g.point(4, 8, 'C', { dx: 0, dy: -7 });
  return g;
}
...
function page41Grid() {
  ...
  g.point(0, 0, 'O', { dx: -7, dy: 11 });
  g.point(8, 0, 'A', { dx: 5, dy: 11 });
  g.point(0, 6, 'B', { dx: -7, dy: -6 });
  g.point(2, 2, 'P', { dx: 5, dy: -5 });
  g.point(4, 3, 'Q', { dx: 5, dy: -5 });
  g.point(6, 3, 'R', { dx: 5, dy: -5 });
  return g;
}
...
function page43Grid() {
  ...
  g.point(5, 8, 'Q', { dx: 0, dy: -7 });
  g.point(11, 8, 'R', { dx: 0, dy: -7 });
...
function page44Grid() {
  ...
  g.point(1, 1, 'A', { dx: -5, dy: 11 });
  g.point(9, 1, 'B', { dx: 5, dy: 11 });
  g.point(4, 7, 'C', { dx: 0, dy: -7 });
  g.point(5, 1, 'M', { dx: 0, dy: 12 });
  return g;
}
...
function page45Grid() {
  ...
  g.point(1, 1, 'A', { dx: -5, dy: 11 });
  g.point(10, 1, 'B', { dx: 5, dy: 11 });
  g.point(3, 7, 'C', { dx: 0, dy: -7 });
  g.point(4, 1, 'D', { dx: 0, dy: 12 });
  return g;
}
  ...
  blocks: [
    cols(
      task(`במלבן ${pt('A', 1, 1)}, ${pt('B', 9, 1)}, ${pt('C', 9, 7)}, ${pt('D', 1, 7)} שורטט האלכסון AC:`,
        ...
        subs([
          `האם המשולשים ABC ו־ACD חופפים? ${SHORT}`,
          `האם שטחיהם שווים? ${SHORT}`
        ]),
        lines(2, { label: 'הסבירו בלי להשתמש שוב בנוסחה:' })
      ),
      figure(page39Grid(), 'אלכסון ונקודות על ישר מקביל לבסיס')
    ),
...
const page40 = {
  ...
  blocks: [
    cols(
      ...
      figure(page40Grid(), 'השלמה למלבן וחיסור')
    ),
...
const page41 = {
  ...
  blocks: [
    cols(
      ...
      figure(page41Grid(), 'שלוש נקודות ביחס למשולש')
    ),
  ...
  blocks: [
    cols(
      task(`נתונות ${pt('A', 2, 3)}, ${pt('B', 10, 3)}. שטח ABC הוא ${ltr('20')}:`,
        ...
        subs([
          `שיעור Y אפשרי מעל AB: ${SHORT}`,
          `שיעור Y אפשרי מתחת ל־AB: ${SHORT}`
        ])
      ),
      figure(page42Grid(), 'שני ישרים אפשריים לקודקוד C')
    ),
...
const page43 = {
  ...
  blocks: [
    cols(
      ...
      figure(page43Grid(), 'שלושה קודקודים על ישר מקביל לבסיס')
    ),
...
const page45 = {
  ...
  blocks: [
    cols(
      ...
      figure(page45Grid(), 'שני משולשים בעלי גובה משותף')
    ),
