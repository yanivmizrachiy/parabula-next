...
test('gateway and canonical readers are required and versioned in production builds', () => {
  for (const asset of ['catalog.html', 'catalog.js', 'catalog.css', 'catalog-deep-link.js', 'mobile-app.html', 'mobile-app.js', 'systems-workbook.html', 'meta/two-variable-systems-manifest.json']) {
...
test('gateway and both canonical readers have offline shells', () => {
  for (const asset of ['systems-workbook.html', 'catalog.html', 'catalog.css', 'catalog.js', 'catalog-deep-link.js', 'mobile-app.html', 'mobile-app.js']) {
