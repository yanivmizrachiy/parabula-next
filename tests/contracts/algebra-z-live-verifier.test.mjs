...
const runbook = fs.readFileSync('docs/algebra-z-live-verification.md', 'utf8');
...
test('the runbook defers all project rules to CLAUDE.md', () => {
  assert.match(runbook, /CLAUDE\.md/);
  assert.doesNotMatch(runbook, /מקור הכללים היחיד החדש/);
});