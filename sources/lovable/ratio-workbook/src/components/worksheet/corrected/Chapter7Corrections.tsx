...
function CoordinateTriangles() {
  ...
  return (
    <div className="svg-center svg-center--tight">
      <svg viewBox="0 0 300 215" width="320" height="230" role="img" aria-label="מערכת צירים ובה משולשים דומים DOC ו־AOB">
        ...
        <text x={originX + 4 * scale} y={originY + 16}>C(4,0)</text>
        <text x={originX - 45} y={originY - 6 * scale}>D(0,6)</text>
        <text x={originX + 10 * scale} y={originY + 16}>A(10,0)</text>
        <text x={originX - 50} y={originY - 15 * scale}>B(0,15)</text>
      </svg>
    </div>
  );
}
  ...
  return (
    <PageLayout pageNumber={42} chapter={CH} topic={TOPIC}>
      ...
      <Question>
        ...
        <SubQuestion label="ב."><p>מהם שיעורי הנקודה B? ‏B(<Blank />, <Blank />)</p></SubQuestion>
        <SubQuestion label="ג."><p>מהו שטח △AOB? הציגו דרך פתרון.</p><AnswerLine /></SubQuestion>
      </Question>
    </PageLayout>
  );
}
...
function TrapezoidModel() {
  return (
    <div className="svg-center svg-center--tight">
      <svg viewBox="0 0 300 170" width="330" height="185" role="img" aria-label="טרפז ישר זווית שבו AB שווה 12, CD שווה 18, AD ו־BE שווים 8, BC שווה 10 ו־EC שווה 6">
        ...
        <text x="105" y="24" textAnchor="middle">12</text>
        <text x="135" y="126" textAnchor="middle">12</text>
        <text x="195" y="126" textAnchor="middle">6</text>
        <text x="36" y="72">8</text>
        <text x="190" y="65">10</text>
      </svg>
    </div>
  );
}
...
function InscribedRectangleModel() {
  return (
    <div className="svg-center svg-center--tight">
      <svg viewBox="0 0 260 235" width="265" height="240" role="img" aria-label="משולש ישר זווית ABC ובו מלבן BDFE, DF שווה 5, BC שווה 15 ו־AB שווה 18">
        ...
        <text x="12" y="125" transform="rotate(-90 12 125)">AB=18</text>
        <text x="108" y="226">BC=15</text>
        <text x="60" y="84" textAnchor="middle">DF=5</text>
      </svg>
    </div>
  );
}
  ...
  return (
    <PageLayout pageNumber={48} chapter={CH} topic={TOPIC}>
      ...
      <Question>
        ...
        <TrapezoidModel />
        <SubQuestion label="א."><p>מהו היקף הטרפז? הציגו דרך פתרון. תשובה: <Blank /> ס״מ</p></SubQuestion>
        <SubQuestion label="ב.">
      ...
      <Question>
        ...
        <SubQuestion label="א."><p>הסבירו מדוע △ADF ∼ △ABC.</p><AnswerLine /></SubQuestion>
        <SubQuestion label="ב1."><p>מהו יחס הדמיון △ADF : △ABC? תשובה: <Blank /></p></SubQuestion>
        <SubQuestion label="ב2."><p>מהו שטח המלבן BDFE? הציגו דרך פתרון.</p><AnswerLine /></SubQuestion>
      </Question>
    </PageLayout>
  );
}
