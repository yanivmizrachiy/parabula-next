...
requireText(guardWorkflow, 'node scripts/validate-equations-app.mjs', 'equations guard workflow');
requireText(guardWorkflow, 'node scripts/validate-equations-design-pass-strict.mjs', 'equations guard workflow');
requireText(guardWorkflow, 'node scripts/validate-equations-print-scope.mjs', 'equations guard workflow');
requireText(guardWorkflow, 'node scripts/validate-equations-pilot-page-1.mjs', 'equations guard workflow');
requireText(guardWorkflow, 'node scripts/validate-equations-easy-edits.mjs', 'equations guard workflow');
requireText(guardWorkflow, 'node scripts/validate-page-95-editable.mjs', 'equations guard workflow');
requireText(guardWorkflow, 'node scripts/validate-access-layer.mjs', 'equations guard workflow');
...
console.log('guard_workflow=granular');
