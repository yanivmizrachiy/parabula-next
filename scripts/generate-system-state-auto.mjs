...
fs.writeFileSync(path.join(root, 'meta', 'audit', 'generated-system-state.json'), JSON.stringify(state, null, 2) + '\n', 'utf8');
console.log('Generated meta/audit/generated-system-state.json');
