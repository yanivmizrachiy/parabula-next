...
- `mobile-topics.json` — **בוטל ונמחק (2026-07-10)**: הנייד קורא ישירות מ-`meta/topics.json`; mirror נוסף אסור, והבדיקות (`validate:access`, `validate:mobile`, audit) נכשלות אם הקובץ חוזר.
